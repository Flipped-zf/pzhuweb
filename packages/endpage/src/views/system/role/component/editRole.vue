				...
				<el-row :gutter="35">
					...
					<el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
						<el-form-item label="角色标识">
							...
							<el-input disabled v-model="ruleForm.roleSign" placeholder="请输入角色标识" clearable></el-input>
						</el-form-item>
					</el-col>
					<el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
...
export default defineComponent({
	...
	setup() {
		...
		// 新增
		const onSubmit = () => {
			request.updateRole(state.ruleForm.statusId, state.ruleForm).then((res) => {
				console.log(res);
			});
